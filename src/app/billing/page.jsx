        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {plans.map((plan) => (
              <div
                key={plan.name}
                className={`relative rounded-3xl border p-8 transition duration-300 hover:-translate-y-2 hover:shadow-2xl ${plan.popular
              ...
              >
                ...
                <button onClick={() => handlePayment(plan)}
                  className={`mt-10 w-full rounded-xl py-3 font-semibold transition cursor-pointer ${plan.popular
