...
const CreateOptions = () => {
  return (
    <div className='grid grid-cols-2 gap-5 '>
        <Link href={'/dashboard/create-interview'} className='bg-white border border-gray-300 p-3 rounded-xl cursor-pointer hover:scale-105 transition-all duration-200 ease-in-out'>
