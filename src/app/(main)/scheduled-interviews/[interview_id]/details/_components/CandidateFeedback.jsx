...
const handlePrint = useReactToPrint({
  ...
  return (
    <Dialog onOpenChange={handleOpenChange}>
      ...
      <DialogContent
  className="w-[95vw] max-w-5xl h-[90vh] overflow-hidden rounded-3xl p-0"
>
  <div
  ref={(el) => {
  ...
  className="h-full overflow-y-auto no-scrollbar p-8"
>
            <DialogHeader>
            ...
            <div className="rounded-2xl mt-3 border bg-white shadow-sm p-6">
              ...
              <div
                className={`rounded-2xl mt-3 border-2 p-6 shadow-sm transition-all duration-300 ${recommendation
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <h2
                    className={`text-2xl font-bold ${recommendation
                        ? "text-green-700"
                        : "text-red-700"
                      }`}
                  >
