      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            {/* Upload Zone */}
            <div className="group flex min-h-[350px] cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-slate-300 bg-slate-50 px-6 text-center transition-all duration-200 hover:border-indigo-400 hover:bg-indigo-50/40">
              ...
              <button
                type="button"
                className="mt-6 inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:bg-indigo-700 hover:shadow-md"
              >
                <UploadCloud size={17} />
                Choose Resume
              </button>
